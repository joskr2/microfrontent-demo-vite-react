...
type DropdownButtonProps<T extends React.ElementType = typeof Button> = {
  className?: string;
} & Omit<Headless.MenuButtonProps<T>, 'className'> & (T extends typeof Button ? Pick<ButtonProps, 'color'> : Record<string, never>);
