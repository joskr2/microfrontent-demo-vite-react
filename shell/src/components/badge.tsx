...
type BadgeButtonProps = BadgeProps & {
  ...
  children: React.ReactNode;
    ...
    | Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'className' | 'ref' | 'as'> & { href?: never; ref?: ForwardedRef<HTMLButtonElement> }
    | Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'className' | 'ref'> & { href?: string; ref?: ForwardedRef<HTMLAnchorElement> }
  );
...
export const BadgeButton = forwardRef<HTMLButtonElement | HTMLAnchorElement, BadgeButtonProps>(
  function BadgeButton({ color = 'zinc', className, children, href, ...props }, ref) {
    const classes = clsx(
      className,
    ...
    return href ? (
      <Link {...(props as Omit<AnchorHTMLAttributes<HTMLAnchorElement>, 'className' | 'ref'>)} href={href} className={classes} ref={ref as ForwardedRef<HTMLAnchorElement>}>
        <TouchTarget>
      ...
      <Headless.Button
        {...(props as Omit<ButtonHTMLAttributes<HTMLButtonElement>, 'className' | 'ref' | 'as'>)}
        className={classes}
